...
- Python 3.11 (backend Django 4.x + Gunicorn), JavaScript ES2022 (frontend React 18, Vite 5) + React 18, TanStack Query 5, react-apexcharts 1.4.0, ApexCharts 3.54.0, Django 4.x, django-ratelimit, bleach (006-ui-datepicker-aquapark-csrf)
...
## Recent Changes
- 006-ui-datepicker-aquapark-csrf: Added Python 3.11 (backend Django 4.x + Gunicorn), JavaScript ES2022 (frontend React 18, Vite 5) + React 18, TanStack Query 5, react-apexcharts 1.4.0, ApexCharts 3.54.0, Django 4.x, django-ratelimit, bleach
